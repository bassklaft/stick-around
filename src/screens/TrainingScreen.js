...
const s = StyleSheet.create({
  ...
  cardHd:       { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 6, gap: 10 },
  catChip:      { flexShrink: 0, flexDirection: "row", alignItems: "center", gap: 4, paddingHorizontal: 8, paddingVertical: 3, borderRadius: 4 },
  catText:      { fontSize: 9, fontWeight: "800", letterSpacing: 0.7 },
  cadence:      { flexShrink: 1, fontSize: 11, color: theme.muted, fontWeight: "600", textAlign: "right" },
